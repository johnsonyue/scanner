...
echo "scamper -c 'dealias -m ally' -p 10000 -M $node_name -C $date -o $out_file_alias -O warts -f $cwd$trace_ip_file"
scamper -c 'dealias -m ally' -p 10000 -M $node_name -C $date -o $out_file_alias -O warts -f $cwd$trace_ip_file
